...
行程问题是指与物体运动相关的数学问题，通常涉及速度、时间、距离之间的关系。
其基本公式为：
...
其中，\(v\) 表示速度，\(t\) 表示时间，\(s\) 表示距离。
行程问题通常分为以下几类：
\begin{itemize}
\item 同向行驶：两个物体沿同一直线同方向运动，
\item 相向行驶：两个物体沿同一直线相向运动，
\item 追及问题：一个物体追赶另一个物体，
\item 环行问题：物体在环形轨道上运动。
\item 抛物线运动：物体在抛物线运动。
\end{itemize}
\section{一元二次方程}
\[
